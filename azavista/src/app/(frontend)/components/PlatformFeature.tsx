  ...
  return (
    <section className="py-16">
      <div className="max-w-4xl mx-auto px-6 text-center">
        ...
        {description && (
          <div className="mt-8 text-lg text-gray-600 leading-relaxed max-w-4xl mx-auto [&_ul]:list-disc [&_ul]:pl-6 [&_ol]:list-decimal [&_ol]:pl-6 [&_li]:mb-1 [&_li::marker]:text-[#1e61f0]">
